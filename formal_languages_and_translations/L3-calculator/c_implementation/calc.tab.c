...
{
       0,    80,    80,    81,    84,    85,    92,    98,   103,   109,
     115,   121,   134,   146,   150
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MUL", "DIV", "EOL", "L_PAREN", "R_PAREN", "POW", "UMINUS", "$accept",
...
{
      -7,    14,    -7,    -4,    -7,    -2,    -7,    -2,    -7,    20,
      -7,    -7,    28,    -2,    -2,    -2,    -2,    -7,    -2,    -7,
      30,    30,    -6,    -6,     1
};
...
{
      11,     4,    12,     5,    10,    18,     0,     7,    20,    21,
      22,    23,    -1,    24,     2,     3,     0,     4,     0,     5,
       0,     0,     6,     7,    13,    14,    15,    16,    17,     0,
       0,    18,    13,    14,    15,    16,    15,    16,    19,    18,
       0,    18
};

static const yytype_int8 yycheck[] =
{
       5,     3,     7,     5,     8,    11,    -1,     9,    13,    14,
      15,    16,    11,    18,     0,     1,    -1,     3,    -1,     5,
      -1,    -1,     8,     9,     4,     5,     6,     7,     8,    -1,
      -1,    11,     4,     5,     6,     7,     6,     7,    10,    11,
      -1,    11
};
...
{
       0,    14,     0,     1,     3,     5,     8,     9,    15,    16,
       8,    16,    16,     4,     5,     6,     7,     8,    11,    10,
      16,    16,    16,    16,    16
};
...
#line 103 "calc.y"
        ...
        if (!error_flag) {
            printf("+ "); 
            (yyval.ival) = mod_p((long long)(yyvsp[-2].ival) + (yyvsp[0].ival)); 
        }
    }
...
#line 121 "calc.y"
        ...
        if (!error_flag) {
            ...
            if ((yyvsp[0].ival) == 0) {
                ...
                int inv = mod_inverse((yyvsp[0].ival));
                (yyval.ival) = mod_p((long long)(yyvsp[-2].ival) * inv);
            }
        }
    }
...
#line 134 "calc.y"
        ...
        if (!error_flag) {
            ...
            if ((yyvsp[-2].ival) == 0 && (yyvsp[0].ival) < 0) {
                 ...
                 (yyval.ival) = mod_pow((yyvsp[-2].ival), (yyvsp[0].ival)); 
            }
        }
    }
...
#line 146 "calc.y"
                            { 
        (yyval.ival) = mod_p(-(yyvsp[0].ival));
        printf("NEG ");
    }
#line 1242 "calc.tab.c"
    break;

  case 14: /* expr: L_PAREN expr R_PAREN  */
#line 150 "calc.y"
                           { 
